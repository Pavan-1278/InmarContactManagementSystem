...
//                          alert(data);
       ...
       app.controller("manager",function($scope,send_group_details,collect_group_info,send_contact_details,delete_contact_details,send_editcontact,send_addcontact){
            $scope.g_name="";
            $scope.g_id="";
            $scope.collect="";
    ...
    <div class="row">
         <div class="col-sm-12 col-xs-12 result_holder" id="result_holder">
              <div class="search" ng-hide="group_module">
                    <input class="fieldcss" type="text" name="search_key" ng-model="search_key">
              </div>
              <div class="search" ng-hide="contact_module">
                    <input class="fieldcss" type="text" name="search_contact_key" ng-model="search_contact_key">
              </div>
